/*
Problem Statement : Given a set of non-negative integers and a value sum, the task is to check if there is a subset of the given set whose sum is equal to the
given sum.

input :
set[] = {3,34,4,12,5,2} , sum =9     output : True
set[] = {3,34,4,12,5,2} , sum =30     output : False
*/
